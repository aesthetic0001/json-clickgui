          ...
          <div className="flex flex-row gap-x-5 h-full items-center">
            ...
            <div className="relative w-full h-full flex flex-col">
              ...
              <div className="relative flex flex-col gap-y-2 w-full h-full">
                <div className="mt-3 w-1/2 self-center bg-gradient-ring hover:bg-gradient-ring-hover rounded-3xl p-[2px] transition-all ease-in-out">
                  <input
                      type="text"
                ...
                <div className="flex-grow flex flex-col w-full h-full gap-y-2 overflow-y-scroll no-scrollbar">
                  {
                    Array.from(Array(10).keys()).map((i) => {
                      return <Feature name={`feature ${i + 1}`} description={`description ${i + 1}`} section={`section ${i + 1}`} key={i} />
                    })
                  }
                </div>
              </div>
